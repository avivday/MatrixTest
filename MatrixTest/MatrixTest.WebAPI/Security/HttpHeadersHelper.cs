...
namespace MatrixTest.WebAPI.Security
{
    internal static class HttpHeadersHelper
    {
        ...
        internal static void AddAuthenticationInfoValueToCookie(this HttpActionExecutedContext responseAction, string value)
        {
            ...
            responseAction.Response.Headers.Add("TicketTimestamp", DateTimeOffset.Now.Add(SettingsManager.TicketDurationTimeSpan.Value).ToUnixTimeMilliseconds().ToString(""));
