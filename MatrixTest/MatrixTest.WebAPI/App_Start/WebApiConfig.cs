...
namespace MatrixTest.WebAPI
{
    ...
    internal static class WebApiConfig
    {
        ...
        public static void Register(HttpConfiguration config)
        {
            ...
            {
                config.EnableCors(new EnableCorsAttribute(SettingsManager.Origins, SettingsManager.Headers, SettingsManager.Methods, SettingsManager.ExposedHeaders) { SupportsCredentials = true });
            }
